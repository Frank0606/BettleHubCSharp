...
public class SeedEscarabajo : IEntityTypeConfiguration<Escarabajo>
{
    ...
    { 
        ...
        Familia = "familia1", 
        Genero = "género1", 
        Mandibula = "mandíbula1", 
        Nombre_comun = "nombre_común1", 
        Ojos = "ojos1", 
        Patas = 01, 
        Torax = "tórax1", 
    ...
    { 
        ...
        Familia = "familia2", 
        Genero = "género2", 
        Mandibula = "mandíbula2", 
        Nombre_comun = "nombre_común2", 
        Ojos = "ojos2", 
        Patas = 02, 
        Torax = "tórax2", 
    ...
    { 
        ...
        Familia = "familia3", 
        Genero = "género3", 
        Mandibula = "mandíbula3", 
        Nombre_comun = "nombre_común3", 
        Ojos = "ojos3", 
        Patas = 03, 
        Torax = "tórax3", 
    ...
    { 
        ...
        Familia = "familia4", 
        Genero = "género4", 
        Mandibula = "mandíbula4", 
        Nombre_comun = "nombre_común4", 
        Ojos = "ojos4", 
        Patas = 04, 
        Torax = "tórax4", 
